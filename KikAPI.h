 ...
 *      [KikAPIClient registerAsKikPluginWithAppID:\@"your apps' ID" withHomepageURI:\@"http://www.myhomepage.com" addAppButton:YES];
 * }</code></pre>
 ...
 *      KikAPIData *myData = [KikAPIClient handleOpenURL:url];
 *      // ...
 * }</code></pre>
 ...
 *      // We have to display content sent to us
 * } else if (myData.type == KikAPIDataTypePick) {
 *      // We have to select content to send
 * } else if (myData.type == KikAPIDataTypeNotKik) {
 *      // We were not launched from within Kik
 * }</code></pre>
 ...
 * myMessage.genericURIs = [NSArray arrayWithObjects:\@"my generic URI", nil];</code></pre>
 * For more information on these properties, @see KikAPIMessage
 * -# Finally, send the message off to Kik!
 * <pre><code> [KikAPIClient sendMessage:myMessage toConversation:conversationID];
 * // We're done! It was that easy!</code></pre>
 */
 ...
 * <pre><code>myMessage.extras = [NSDictionary dictionaryWithObjectsAndKeys:@"Mark Twain", @"author", @"435", @"pages", nil];</code></pre>
 */
